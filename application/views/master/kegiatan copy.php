					...
					<table id="table"
						...
						<thead class="thead-light">
							<tr>
								...
								<th data-field="kode_program" data-width="10" data-width-unit="%" >Kode Program</th>
								<th data-field="kode_kegiatan" data-sortable="true" data-width="15" data-width-unit="%" >Kode kegiatan</th>
	...
	function newForm(){
		...
		$.ajax({
			...
			success: function (data){
				let res = data.map((d)=>{
					return {id:d._id,text:d.kode_program}
				})
				$('#kd_program').select2({
